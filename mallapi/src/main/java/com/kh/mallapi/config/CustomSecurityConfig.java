...
import com.kh.mallapi.securty.filter.JWTCheckFilter;
...
public class CustomSecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		// 로그인 상태를(인증,인가) 서버 세션으로 저장하지 않고, 리액트는 모든 페이지 요청할떄 인증,인가 정보를 전달해야한다.
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedMethods(Arrays.asList("HEAD", "GET", "PATCH", "POST", "PUT", "DELETE"));
